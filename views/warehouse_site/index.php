...
<!--                                 <div class="panel-left pull-left blue">
                                ...
                                <div class="panel-right">
                                    <?php 
                                        ...
                                        $sql = "SELECT COUNT(*) FROM tbl_item WHERE tbl_item.dept_id = 1;";
                        ...
                        <?php 
                            ...
                            $sql = "SELECT COUNT(*)
                                    ...
                                    WHERE tbl_item_history.quantity <= tbl_item.minStockCount 
                                    AND tbl_item_history.history_id = (SELECT MAX(tbl_item_history.history_id) FROM tbl_item_history) 
                                    AND tbl_item.dept_id = 1;";
                            $row = mysqli_fetch_array(mysqli_query($conn, $sql), MYSQL_NUM);
                        ?>
                        <div class="col-md-3 col-sm-3 col-xs-3">
                                    ...
                                    <table class="table table-striped table-bordered table-condensed table-hover" id="recordsTable">
                                        ...
                                        <?php 
                                            ...
                                            $sql = "SELECT 
                                                    ...
                                                    FROM tbl_item
                                                    INNER JOIN tbl_item_history
                                                    ON tbl_item.item_id = tbl_item_history.item_id
                                                    WHERE tbl_item.dept_id = 1 AND tbl_item_history.history_id = (SELECT MAX(tbl_item_history.history_id) FROM tbl_item_history) AND tbl_item.status = 0
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header text-center">
                    ...
                    <h3 class="modal-title" id="myModalLabel"><strong>New Item</strong></h3>
                            ...
                            <form role="form" class="form-horizontal" action="phpScripts/addNewItem.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group date form_date col-md-12">
                                                <input id="date" name="date" class="form-control" type="text" value="<?php echo date('Y-m-d'); ?>" placeholder="YEAR-MONTH-DAY" required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                                <label for="boxNumber"><label class="text-danger"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></label> Box Number:</label>
                                                <input type="text" name="boxNumber" class="form-control" id="boxNumber" placeholder="Box Number" required autocomplete="off">                                                     
                                        </div>                                                        
                                        <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <br><button type="submit" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-floppy-disk"></span> Save</button>
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>                                                                                                                                                           
                            </form>   
